...
- **Windows Installer** : Get the current [`owlcms_setup_53.1.1.exe`](https://github.com/owlcms/owlcms4/releases/download/53.1.1/owlcms_setup_53.1.1.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4/releases/latest) ).
